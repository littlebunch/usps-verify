...
class FootNote extends RatpackGormEntity<FootNote>{
    ...
    static constraints = {
		fnId blank:false,nullable:false
		fnType blank:false, nullable:false
		fnText blank:false,nullable:false
		nutrient nullable:true,blank:true
    }
	static mapping = {
		fnId sqlType:"VARCHAR(8)"
		fnType sqlType:"VARCHAR(8)"
		fnText sqlType:"VARCHAR(1024)"
